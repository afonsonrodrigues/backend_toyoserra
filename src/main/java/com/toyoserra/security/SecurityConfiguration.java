...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
        	...
        	.antMatchers(HttpMethod.GET, "/ordemServico/aberto").permitAll()
        	.antMatchers(HttpMethod.GET, "/ordemServico/todos").permitAll()
        	.antMatchers(HttpMethod.GET, "/ordemServico/fechada").permitAll()
